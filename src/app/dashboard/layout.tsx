...
function DashboardLayoutContent({ children }: { children: React.ReactNode }) {
  ...
  //   { href: '/dashboard', icon: Home, label: 'Dashboard' },
  //   { href: '/dashboard/projects', icon: FolderOpen, label: 'Projects' },
  //   { href: '/dashboard/upgrade', icon: Star, label: 'Upgrade', badge: 'Pro' },
  //   { href: '/dashboard/feedback', icon: MessageSquare, label: 'Feedback' },
  // ], [])
...
// import { useRef, useState, useEffect, useMemo, useCallback } from 'react'
// import Link from 'next/link'
// import { Plus, Home, FolderOpen, Star, MessageSquare, LogOut, User, Shield, Zap, Menu, X,Settings} from 'lucide-react'
// import DashboardErrorBoundary from '@/components/DashboardErrorBoundary'
...
//     { href: '/dashboard/projects', icon: FolderOpen, label: 'Projects', badge: null },
//     { href: '/dashboard/upgrade', icon: Star, label: 'Upgrade', badge: 'Pro' },
//     { href: '/dashboard/feedback', icon: MessageSquare, label: 'Feedback', badge: null },    
//   ], [])
...
//                     />
//                     <div 
//                       className="w-full h-full bg-gradient-to-br from-violet-600 to-indigo-600 rounded-full flex items-center justify-center text-white font-bold hidden"
//                     >
//                       {(user.email.match(/[a-zA-Z]/)?.[0] || 'U').toUpperCase()}
//                     </div>
//                   </div>
...
//                 {profileMenuOpen && (
//                   <div className="absolute right-0 mt-2 w-56 bg-white/10 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 p-2 z-50">
//                     <div className="px-4 py-3 border-b border-white/20">
...
//                           {item.label}
//                           {item.badge && (
//                             <span className="ml-auto px-2 py-0.5 text-xs bg-emerald-500/20 text-emerald-400 rounded-full font-bold">
//                               {item.badge}
//                             </span>
//                           )}
//                         </Link>
...
//                   {(() => {
//                     const firstLetter = user.email.split('@')[0].match(/[a-zA-Z]/)?.[0];
...
//                   href={item.href}
//                   onClick={() => setMobileMenuOpen(false)}
//                   className="flex items-center gap-3 px-4 py-3 text-white hover:bg-white/10 rounded-xl transition"
//                 >
//                   <item.icon className="h-5 w-5" />
//                   {item.label}
//                   {item.badge && (
//                     <span className="ml-auto px-2 py-1 text-xs bg-emerald-500/20 text-emerald-400 rounded-full font-bold">
//                       {item.badge}
//                     </span>
//                   )}
//                 </Link>
...
//   // Memoize the navigation redirect effect
//   useEffect(() => {
//     if (!loading && !user) {
//       router.push('/')
//     }
