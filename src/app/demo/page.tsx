...
export const metadata: Metadata = {
  title: 'Live Demo - FormMirror',
  description: 'Try FormMirror live. Fill out the form and watch analytics update in real-time — no cookies, no tracking.',
  keywords: 'live demo, form analytics demo, real-time tracking, privacy-first',
  openGraph: {
    title: 'Live Demo - FormMirror',
    description: 'See form analytics update in real-time. No personal data. Just insights.',
    url: 'https://formmirror.com/demo', // Fixed trailing space
    type: 'website',
  },
}
