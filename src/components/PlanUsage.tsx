...
export function PlanUsage() {
  ...
  // ✅ Safely parse limits to numbers (in case they're strings like "5", "1000", etc.)
  const maxProjects =
    currentFeatures.maxProjects === 'Unlimited'
      ? Infinity
      : Number(currentFeatures.maxProjects)

  const maxInteractions =
    currentFeatures.maxFormInteractions === 'Unlimited'
      ? Infinity
      : Number(currentFeatures.maxFormInteractions)

  // Calculate percentages — now safe because maxProjects/maxInteractions are numbers or Infinity
